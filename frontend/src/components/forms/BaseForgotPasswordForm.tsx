...
const BaseForgotPasswordForm: React.FC<BaseForgotPasswordFormProps> = ({
  onSubmit,
  loading = false,
  ...
  const handleFormSubmit = (data: ForgotPasswordSchema) => onSubmit(data);
...
export default BaseForgotPasswordForm;