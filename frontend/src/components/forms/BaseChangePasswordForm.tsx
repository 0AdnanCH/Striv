...
import { changePasswordSchema, type ChangePasswordType } from '../../modules/client/schemas/changePassword.schema';
...
const BaseChangePasswordForm: React.FC<BaseChangePasswordFormProps> = ({ loading = false, onSubmit }) => {
