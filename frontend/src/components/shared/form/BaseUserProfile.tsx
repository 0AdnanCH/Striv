...
export const BaseUserProfile: React.FC<BaseUserProfileProps> = ({ data, showGender = true, showAge = true, showHeight = true, showWeight = true, onFieldUpdate, theme = {} }) => {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        {showGender && (
          <EditableField
            ...
            onChange={(v) => onFieldUpdate?.('gender', v as GenderType)}
            schema={genderSchema}
            variant="select"
            options={[
